...
>
> ablation run `M5-ABL-20260920T211134Z` (git `bf4f9a3`, dirty tree, evaluator source hash `c0a44bb0c14acd88`) · active variables from DOE run `M4-DOE-20260920T204844Z`
...
5. **Budget is counted in evaluations, not in cost.** In this run one evaluation took a median of 0.25 s of worker time, and one LLM round a mean of 177 s. Hypervolume per evaluation and hypervolume per second are different questions; this report answers the first.
