...
>
> ablation run `M5-REPLAY-20260921T012107Z` (git `eac22c7`, dirty tree, evaluator source hash `51292369ab52d18a`) · active variables from DOE run `M4-DOE-20260920T204844Z` · **replay of `M5-ABL-20260920T211134Z`**
...
| `bo_parego` | 5 | 200 | 121 | 0 | 103.0 | **0.3520 ± 0.0011** | 0.3506 – 0.3530 | 7.8 | 0.602 / 0.445 | 20 | 0 | — | — |
| `ai_agent` | 5 | 200 | 184 | 0 | 163.8 | **0.3556 ± 0.0000** | 0.3555 – 0.3556 | 72.4 | 0.307 / 0.178 | 23 | 47 | 704145 / 816076 | 37 of 937 |
| `ai_adaptive` | 2 | 200 | 188 | 0 | 161.5 | NOT YET MEANINGFUL — no second fidelity available (0.3556; every candidate at Fidelity 1 (`cfd_surface_v2`), 0 promotions to a new CFD case) | 0.3556 – 0.3556 | 75.5 | 0.306 / 0.182 | 31 | 20 | 303254 / 319308 | 24 of 384 |
...
No other run's recorded window overlaps this one's (2026-09-21T01:21:07+00:00 to 2026-09-21T01:24:54+00:00); machine load was still not logged, so wall times are indicative only.
...
5. **Budget is counted in evaluations, not in cost.** In this run one evaluation took a median of 0.14 s of worker time, and one LLM round a mean of 177 s. Hypervolume per evaluation and hypervolume per second are different questions; this report answers the first.
